...
<div class="col1"> 
                ...
                <div class="clear">&nbsp;</div>
				<div class="col1"> 
					<label class="info" title="<?php _e('To use another pseudo streaming script on other server, if is empty it takes the default value on the plug-in settings.', 'stream-video-player'); ?>" for="streamer"><?php _e('Streamer:', 'stream-video-player'); ?></label> 				</div>
				<div class="col2"> 
				...
				<div class="col1"> 
					<label title="<?php _e('Fixes the HTML overlapping of the Flash Video by adding the parameter [wmode=opaue] and it adds a CSS style to prevent FireFox dotted frame around the video.', 'stream-video-player'); ?>" class="info" for="opfix"><?php _e('Fix HTML overlapping:', 'stream-video-player'); ?></label> 
				</div>
				<div class="col4"> 
